<template>
  <main class="mt-10">
    ...
    <div
      ...
      v-if="loadingBookmark === false && bookmarks.length > 0"
    >
      <AccommodationCard
    ...
    <div
      class="w-full flex flex-row flex-wrap"
      v-else-if="loadingBookmark === false && bookmarks.length === 0"
    >
      <div
      ...
      >
        <div class="max-w-md">
          <p class="text-2xl md:text-3xl font-light leading-normal">
            You don't have any Bookmarked Accommodation.
          </p>
          <p class="mb-8">
            You can find plenty of accommodation on our homepage.
          </p>
        </div>
        <div class="max-w-lg">
          <svg
    ...
    <div class="w-full flex flex-row flex-wrap" v-else>
      <div
        class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700"
      >
        <div class="max-w-md">
          <p class="text-2xl md:text-3xl font-light leading-normal">
            Loading your Bookmark please wait.
          </p>
        </div>
        <div class="max-w-lg">
          <svg
...
export default {
  ...
  computed: {
    ...
    loadingBookmark() {
      return this.$store.state.loadingBookmark;
    },
  },
  created() {
    this.$toast.open({
