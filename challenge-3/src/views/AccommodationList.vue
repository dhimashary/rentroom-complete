<template>
  <main class="mt-10">
    ...
    <div class="block lg:flex lg:space-x-2 px-2 lg:p-0 mt-10 mb-10">
      ...
      <!-- post cards -->
      <div
        class="w-full lg:w-3/4 flex flex-row flex-wrap"
        v-if="!isLoading && accommodations.length > 0"
      >
        <AccommodationCard
      ...
      <div
        class="w-full lg:w-3/4 flex flex-row flex-wrap"
        v-else-if="!isLoading && accommodations.length === 0"
      >
        <div
        ...
        >
          <div class="max-w-md">
            <p class="text-2xl md:text-3xl font-light leading-normal">
              Sorry we couldn't find accommodation with this criteria.
            </p>
            <p class="mb-8">
